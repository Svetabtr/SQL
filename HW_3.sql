DROP SCHEMA IF EXISTS homework_3;
CREATE SCHEMA IF NOT EXISTS homework_3;
USE homework_3;
...
FROM activity_staff
GROUP BY staff_id
HAVING (SELECT SUM(count_pages)) > 500;
